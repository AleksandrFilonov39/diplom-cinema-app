      ...
      <div className="buy-ticket-info">
        <div>
          <div className="buy-ticket-film-info">
            ...
            <p className="buy-ticket-film-about-value">{state.filmName}</p>
          </div>
          <div className="buy-ticket-film-info">
            <p className="buy-ticket-film-about-atr">В зале:</p>
            <p className="buy-ticket-film-about-value">{state.hallName}</p>
          </div>
          <div className="buy-ticket-film-info">
            <p className="buy-ticket-film-about-atr">Начало сеанса:</p>
            <p className="buy-ticket-film-about-value">{state.seance}</p>
          </div>
          <div className="buy-ticket-film-info">
            <p className="buy-ticket-film-about-atr">Стоимость</p>
        ...
        <div>
          <p className="buy-ticket-film-last-info">
            После оплаты билет будет доступен в этом окне, а также придёт вам на
            почту. Покажите QR-код нашему онтроллёру у входа в зал.
          </p>
