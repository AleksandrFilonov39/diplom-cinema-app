      ...
      <div className='wrp-addHall-form'>
        ...
        <div className='wrp-form-header'>
          ...
          <form className='wrp-form-addHall' onSubmit={addHall}>
            <label htmlFor="hallName" className='form-addHall-title'>Название зала</label>
            <input type="text" name='hallName' placeholder='Например, «Зал 1»' className='form-addHall-input' onChange={handleChange}/>
            <div className='wrp-form-addHall-btns'>
              <AdminButton title={'добавить зал'} onClick={addHall}/>
              <button className='form-addHall-cancelBTN' onClick={navigateTo}>отменить</button>
            </div>
          </form>
        </div>
      </div>
